        ...
        <div class="col-lg-6">
            <div class="firstsection d-flex justify-content-center text-center">
                <section class="front-page-optin front-page-optin-gptw ">
                    ...
                    <p class="fp-optin-title landing-page-h1">Feeling Clueless </br>About Landing  <br>Freelance Writing Jobs? </p>
        ...
        <div class="card-decks">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="text-primary  mb-3"><a href="http://thepennyvoice.com" class="text-color">thepennyvoice.com</a></h6>
