                        ...
                        <li class="nav-item dropdown">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark bg-primary services"
                                aria-labelledby="navbarDropdownMenuLinkCourses">
                                <li><a class="dropdown-item N" href="{{route('home')}}" rel="noopener" >I want to land my first Client</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <section class="footer-contact-icons">
                        ...
                        <ul class="list-unstyled pl-5">
                            ...
                            <li class=""><a style="color: inherit" href="https://www.facebook.com/katiethewriter1"
                            ...
                            <li class=""><a style="color: inherit" href="mailto:katiereinah99@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M19 4H5a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3Zm-.67 2L12 10.75L5.67 6ZM19 18H5a1 1 0 0 1-1-1V7.25l7.4 5.55a1 1 0 0 0 .6.2a1 1 0 0 0 .6-.2L20 7.25V17a1 1 0 0 1-1 1Z"/></svg>
